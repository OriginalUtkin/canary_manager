...
class Notifier:
    ...
    def notify_override(
        ...
        previous_canary_releaser_email: Optional[str],
        new_canary_commit_link: str,
        project_name: str,
    ) -> None:
        canary_releaser: str = self.slack_client.get_user(email=canary_releaser_email)

        previous_canary_releaser: str = "Unknown"

        if previous_canary_releaser_email:
            previous_canary_releaser = "@" + self.slack_client.get_user(email=previous_canary_releaser_email)
